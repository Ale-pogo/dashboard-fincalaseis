...
function App() {
  ...
  return (
    <div className="min-h-screen bg-fondo-sitio font-sans text-slate-800 transition-colors duration-300 flex flex-col md:flex-row">
      ...
      <aside className="relative w-full md:w-72 lg:w-80 bg-verde-bosque text-white flex flex-col shadow-xl overflow-hidden md:min-h-screen">
        ...
        <div className="relative z-10 mt-auto border-t border-green-800/70 px-4 py-4 sm:px-5 sm:py-5">
          <div className="flex flex-wrap items-center justify-center gap-3 text-center text-[11px] sm:text-xs text-green-200/90">
            <img src={logoCha} alt="CHA logo" className="h-8 w-auto sm:h-10 shrink-0" />
            <span className="leading-relaxed">© 2026 CHA - Todos los derechos reservados.</span>
          </div>
        </div>
      </aside>
